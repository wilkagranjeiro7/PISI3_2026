...
from pages import (
    advanced_classification_kassiane as advanced_classification,
    agrupamentos,
    classificacao_kassiane as classificacao,
    dataframes,
    eda_kassiane as eda,
    filtros,
    home,
    ...
    [
        ...
        dbc.Nav(
            [
                ...
                dbc.NavLink(
                    "Pipeline Carlos", href="/pipeline-carlos", active="exact"
                ),
            ],
            vertical=True,
            pills=True,
